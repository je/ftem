...
topoLayer = new L.TopoJSON(null, {
                  ...
                  onEachFeature: function (feature, layer) {
                    if (feature.properties) {
                      var content = "<span class='small'><strong><a class='url-break text-prog' href='/fuels/{{yyyy}}/" + feature.properties.u + "/" + "' target='_blank'><span style='color:Black'>" + feature.properties.u + "</a></span></strong></span><br><span class='small'>Name: <strong>" + feature.properties.i + "</strong></span>";
                      layer.on({
                        click: function (e) {
                          $("#perims").html(content);
